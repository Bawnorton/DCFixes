...
public final class DCFixesAnnotationAdjuster implements MixinAnnotationAdjuster {
    ...
    public @Nullable AdjustableAnnotationNode adjust(List<String> targetClassNames, String mixinClassName, MethodNode handlerNode, AdjustableAnnotationNode annotationNode) {
        if (mixinClassName.equals("ca.fxco.moreculling.mixin.renderers.ItemRenderer_faceCullingMixin")) {
            return adjustItemRenderer_faceCullingMixin(mixinClassName, annotationNode, handlerNode);
        } else if (mixinClassName.equals("ca.fxco.moreculling.mixin.models.cullshape.JsonUnbakedModel_cullShapeMixin")) {
            return adjustJsonUnbakedModel_cullShapeMixin(annotationNode);
        }
