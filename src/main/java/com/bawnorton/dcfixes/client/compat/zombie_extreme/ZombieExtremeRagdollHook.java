...
public class ZombieExtremeRagdollHook extends DCFixesRagdollHook {
    public ZombieExtremeRagdollHook() {
        ...
        register(DemolisherEntity.class, (ragdoll, entity) -> {
            ...
            merge(ragdoll, 39, 40, 44);
            connect(ragdoll, 36, false, 39);
            // chest
            merge(ragdoll, 45, 46, 68);
            merge(ragdoll, 69, 70, 74);
